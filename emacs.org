...
#+BEGIN_SRC emacs-lisp
  (use-package ace-window
    ...
    ;; TODO: remove when all deplloys are at 26.
...
#+END_SRC
* Appearance
Use the [[https://github.com/voloyev/sexy-monochrome-theme][sexy monochrome theme]].
#+BEGIN_SRC emacs-lisp
  (use-package sexy-monochrome-theme :ensure t)
  (load-theme 'sexy-monochrome t)
#+END_SRC
Have the mode line of the active window a little lighter.
#+BEGIN_SRC emacs-lisp
